...
class _ManageSlotsPageState extends ConsumerState<ManageSlotsPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () =>
                ref.invalidate(parkingSlotsProvider(widget.lot.id)),
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _buildLegendItem(
                      l10n.translate('availableSlot'),
                      Colors.white,
                      AppColors.primary,
                    ),
                    _buildLegendItem(
                      l10n.translate('maintenanceSlot'),
                      Colors.amber.withValues(alpha: 0.15),
                      Colors.amber,
                      isMaintenance: true,
                    ),
                    _buildLegendItem(
                      l10n.translate('occupiedSlot'),
                      Colors.transparent,
                      Colors.transparent,
                      isCar: true,
                    ),
        ...
        child: SingleChildScrollView(
          ...
          child: Row(
            ...
            children: List.generate(numBlocks, (blockIndex) {
              ...
              final end = (start + slotsPerBlock < slots.length)
                  ? start + slotsPerBlock
                  : slots.length;
              ...
              return Row(
                children: [
                  ...
                  if (blockIndex < numBlocks - 1)
                    _buildAisle(aisleWidth, rowsPerColumn * slotHeight),
                ],
              );
            }),
          ),
  ...
  Widget _buildParkingBlock(
    List<ParkingSlot> blockSlots,
    int rows,
    double width,
    double height,
  ) {
                ...
                children: [
                  ...
                  _buildInfoRow(
                    ...
                    value: slot.isEvCharging
                        ? l10n.translate('integrated')
                        : l10n.translate('none'),
                    valueColor: slot.isEvCharging
                        ? AppColors.success
                  ...
                  if (isOccupied && activeBooking != null) ...[
                    ...
                    _buildInfoRow(
                      ...
                      value:
                          activeBooking.vehiclePlateNumber ??
                        ...
                        onPressed: () async {
                          final confirm = await showDialog<bool>(
                            ...
                            builder: (context) => AlertDialog(
                              title: Text(
                                l10n.translate('confirmCheckoutTitle'),
                              ),
                              content: Text(
                                l10n
                                    .translate('confirmCheckoutSub')
                                    .replaceAll('{slotNumber}', slot.slotNumber)
                                    .replaceAll(
                                      '{plate}',
                                      activeBooking?.vehiclePlateNumber ?? "",
                                    ),
                          ...
                          if (confirm == true && context.mounted) {
                            ...
                            if (success && context.mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    l10n.translate('checkoutSuccess'),
                                  ),
                    ...
                    ElevatedButton.icon(
                      onPressed: () {
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) =>
                                ManagerBookingPage(lot: widget.lot, slot: slot),
                          ),
                        );
                      },
                      icon: const Icon(
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                success
                                    ? l10n
                                          .translate('setMaintenanceSuccess')
                                          .replaceAll(
                                            '{slotNumber}',
                                            slot.slotNumber,
                                          )
